					...
					<div class="scroller-inner">
						...
						<table id="tableConsulta" cellspacing="0" width="100%" class="display">
							...
							<tbody>
									...
									$reg=$obj->detalleEstudianteExamen($grupo,$examen);     
									while ($row = mysqli_fetch_object($reg))
									{
									?>
									<tr>
										<td><input type="checkbox" name="cod_estudiante[]" value="<?php echo $row->cod_estudiante ?>"></td>
										<input type="text" name="txt_cod_examen" value="<?php echo $row->cod_examen ?>" hidden="">
										...
										<td><?php echo $row->nota_examen ?></td>
										<td>
											<div class="dropdown">
  											<button class="dropbtn">Opcion</button>
  											<div class="dropdown-content">
    											<a href="detalleRespuestaEstudiante.php?setCodEstudiante=<?php echo base64_encode($row->cod_estudiante) ?>&setCodExamen=<?php echo base64_encode($row->cod_examen) ?>">Detalle Respuesta</a>
  											</div>
											</div> 
										</td>
									</tr>
