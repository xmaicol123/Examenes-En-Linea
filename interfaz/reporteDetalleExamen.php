					...
					<div class="scroller-inner">
						...
						<table id="tableConsulta" cellspacing="0" width="100%" class="display">
							...
							<tbody>
									...
									$reg=$obj->consultaGrupoReporteExamen($grupo);     
										...
										<td>
											<div class="dropdown">
  											...
  											<div class="dropdown-content">
    											<a href="reporteDetalleNota.php?setCodGrupo=<?php echo base64_encode($row->cod_grupo) ?>&setCodExamen=<?php echo base64_encode($row->cod_examen) ?>">Detalle De Notas</a>
  											</div>
											</div> 
										</td>
									</tr>
