			...
			<div class="mp-pusher" id="mp-pusher">
				...
				<div class="scroller"><!-- this is for emulating position fixed of the nav -->
					<div class="scroller-inner">
						...
						<!--CONTENIDO-->
						<?php
						if ($_GET['setCodDocente']) {

						?>
						<section>
							<div class="centrado">
								<form method="POST" action="regDocente.php" class="formCarrera">
									<h3 class="titulo"><strong>Registrar Docente</strong></h3>
									<div class="contenedor">
										<input type="text" name="txt_cod" value="<?php echo $_GET['setCodDocente'] ?>" hidden="">
										<input type="text" name="txt_nombre" class="input-100" placeholder="Nombre Profesor" value="<?php echo $_GET['setNombre'] ?>">
						...
						<section>
							<div class="centrado">
								<form method="POST" action="regDocente.php" class="formCarrera">
									<h3 class="titulo"><strong>Registrar Docente</strong></h3>
									<div class="contenedor">
										<input type="text" name="txt_nombre" class="input-100" placeholder="Nombre Profesor">
							...
							//FUNCION GUARDAR
								...
								function modificar()
								{
									if ($_POST['txt_cod']) {
										...
										/*ENCRIPTADO DE PASSWORD MD5*/
										$obj = new Docente();
										$obj->setCodDocente($_POST['txt_cod']);
										$obj->setNombre($_POST['txt_nombre']);
										$obj->setNick($_POST['txt_nick']);
										$obj->setPassword($encriptado);
										$obj->setDireccion($_POST['txt_direccion']);
