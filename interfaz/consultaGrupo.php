										...
										<td>
											<div class="dropdown">
  											...
  											<div class="dropdown-content">
    											<a href="regGrupo.php?setCodCarrera=<?php echo $row->cod_carrera ?>&setCodMateria=<?php echo $row->cod_materia ?>&setCodSemestre=<?php echo $row->cod_carrera_materia ?>&setCodDocente = <?php echo $row->cod_profesor ?>&setCodGrupo=<?php echo $row->cod_grupo ?>&setNombre=<?php echo $row->nombre_grupo ?>&setAula=<?php echo $row->aula ?>&setDia=<?php echo $row->dia ?>&setHoraInicio=<?php echo $row->hora_inicio ?>&setHoraSalida=<?php echo $row->hora_salida ?>">Editar</a>
  											</div>
											</div>
										</td>
									</tr>
