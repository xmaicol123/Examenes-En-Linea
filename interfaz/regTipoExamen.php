			...
			<div class="mp-pusher" id="mp-pusher">
				...
				<div class="scroller"><!-- this is for emulating position fixed of the nav -->
					<div class="scroller-inner">
						...
						<section>
							<div class="centrado">
								<form method="POST" action="regTipoExamen.php" class="formCarrera">
									<h3 class="titulo"><strong>Registrar Tipo De Examen</strong></h3>
									<div class="contenedor">
										<input type="text" name="txt_nombre" class="input-100" placeholder="Tipo De Examen">
