					...
					<div class="scroller-inner">
						...
						<table id="tableConsulta" cellspacing="0" width="100%" class="display">
							...
							<tbody>
									...
									?>
									<tr>
										<td><?php echo $row->cod_profesor ?></td>
										...
										<td>
											<div class="dropdown">
  											...
  											<div class="dropdown-content">
    											<a href="regDocente.php?setCodDocente=<?php echo $row->cod_profesor ?>&setNombre=<?php echo $row->nombre_profesor ?>&setNick=<?php echo $row->nick_profesor ?>&setPassword=<?php echo $row->password_profesor ?>&setDireccion=<?php echo $row->direccion ?>&setEmail=<?php echo $row->email ?>&setCelular=<?php echo $row->celular ?>">Editar</a>
  											</div>
											</div>
										</td>
									</tr>
