					...
					<div class="scroller-inner">
						...
						<table id="tableConsulta" cellspacing="0" width="100%" class="display">
							...
							<tbody>
									...
									<?php
									$obj=new Grupo();
									$reg=$obj->consultaGrupoReporte($_SESSION['cod_profesor']);     
										...
										<td>
											<div class="dropdown">
  											...
  											<div class="dropdown-content">
    											<a href="reporteDetalleEstudiante.php?setCodGrupo=<?php echo base64_encode($row->cod_grupo) ?>">Detalle De Alumnos</a>
    											<a href="reporteDetalleExamen.php?setCodGrupo=<?php echo base64_encode($row->cod_grupo) ?>">Detalle De Examen</a>
  											</div>
											</div> 
										</td>
									</tr>
