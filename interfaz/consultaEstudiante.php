										...
										<td>
											<div class="dropdown">
  											...
  											<div class="dropdown-content">
    											<a href="regEstudiante.php?setCodEstudiante=<?php echo $row->cod_estudiante ?>&setNick=<?php echo $row->nick_estudiante ?>&setPassword=<?php echo $row->password_estudiante ?>&setNombre=<?php echo $row->nombre_estudiante ?>&setEmail=<?php echo $row->email ?>&setCelular=<?php echo $row->celular ?>&setFecha=<?php echo $row->fecha_nacimiento ?>&setDireccion=<?php echo $row->direccion ?>">Editar</a>
    											<a href="regEstudianteGrupo.php?setCodEstudiante=<?php echo $row->cod_estudiante ?>">Asignar Grupo</a>
  											</div>
											</div>
										</td>
									</tr>
