			...
			<div class="mp-pusher" id="mp-pusher">
				...
				<div class="scroller"><!-- this is for emulating position fixed of the nav -->
					<div class="scroller-inner">
						...
						<section>
							<div class="centrado">
								<form method="POST" action="regPreguntaFalsoVerdadero.php" class="formCarrera">
									<h3 class="titulo"><strong>Registrar Pregunta</strong></h3>
									<div class="contenedor">
									<!--HACIENDO TRAMPARA PARA AGARAR CODIGO DOCENTE-->
									<input type="text" name="txt_tipo_pregunta" value="0002" hidden="">
									...
									<input type="text" name="txt_opcion1" placeholder="Descripcion" class="input-100" hidden="" value="Falso">

									<input type="text" name="txt_opcion2" placeholder="Descripcion" class="input-100" hidden="" value="Verdadero">

									<input type="text" name="txt_opcion3" placeholder="Descripcion" class="input-100" hidden="" value="">

									<input type="text" name="txt_opcion4" placeholder="Descripcion" class="input-100" hidden="" value="">
									<h3 class="textSelect">Respuesta Correcta</h3>
									<select name="txt_correcta" class="optionBD">
										<option <?php if($_GET['setCorrecta']=="opcion1") echo "selected" ?> value="opcion1">Falso</option>
										<option <?php if($_GET['setCorrecta']=="opcion2") echo "selected" ?> value="opcion2">Verdadero</option>
									</select>
