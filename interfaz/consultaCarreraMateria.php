			...
			<div class="mp-pusher" id="mp-pusher">
				...
				<div class="scroller"><!-- this is for emulating position fixed of the nav -->
					<div class="scroller-inner">
						...
						<h2>CARRERAS Y MATERIAS REGISTRADAS POR SEMESTRE</h2>
						<table id="tableConsulta" cellspacing="0" width="100%" class="display">
							...
							<tbody>
									...
									$reg=$obj->consultaSemestre();     
									while ($row = mysqli_fetch_object($reg))
									{
									?>
									<tr>
										<td><?php echo $row->cod_carrera_materia ?></td>
										...
										<td>
											<div class="dropdown">
  											...
  											<div class="dropdown-content">
    											<a href="regCarreraMateria.php?setCodCarrera=<?php echo $row->cod_carrera ?>&setCodMateria=<?php echo $row->cod_materia ?>&setSemestre=<?php echo $row->semestre ?>&setCodCarreraMateria=<?php echo $row->cod_carrera_materia ?>">Editar</a>
  											</div>
											</div>
										</td>
									</tr>
