					...
					<div class="scroller-inner">
						...
						<table id="tableConsulta" cellspacing="0" width="100%" class="display">
							...
							<tbody>
									...
									<?php
									$obj=new Examen();
									$reg=$obj->consultaExamenEstudiante($_SESSION['cod_estudiante']);     
										...
										<td>
											<div class="dropdown">
  											<a class="dropbtn" href="
  											 	regContadorRegresivo.php?setCodExamen=<?php echo base64_encode($row->cod_examen) ?>">Iniciar</a>
											</div> 
										</td>
									</tr>
									<?php
