						...
						<table id="tableConsulta" cellspacing="0" width="100%" class="display">
							...
							<tbody>
									...
									<tr>
										...
										<td><?php echo $row->sigla_materia ?></td>
										...
										<td>
											<div class="dropdown">
  											...
  											<div class="dropdown-content">
    											<a href="regMateria.php?setCodMateria=<?php echo $row->cod_materia?>&setSigla=<?php echo $row->sigla_materia?>&setNombre=<?php echo $row->nombre_materia?>&setCredito=<?php echo $row->creditos?>&setDescripcion=<?php echo $row->descripcion?>">Editar</a>
  											</div>
											</div>
										</td>
									</tr>
